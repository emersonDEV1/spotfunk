let musicas = [
    {titulo:'Zero Amor', artista:'MC RYAN SP, MC GP, MC IG E MC TUTO', source:'musicas/zero amor.mpeg', img:'./imagens/MC Ryan SP, Mc IG, MC GP - Zero Amor (feat. MC Tuto).jpg'},
    {titulo:'Ei Dama', artista:'MC IG', source:'musicas/EI DAMA.MP4', img:'./imagens/ei dama.jpg'},
    {titulo:'Pique Empresario', artista:'MC RYAN SP, MC KADU, MC TUTO E MC GP', source:'musicas/pique empresario.mp4', img:'./imagens/pique empresario.jpg'}
];
